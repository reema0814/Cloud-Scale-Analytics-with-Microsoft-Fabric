...
9. In the notebook menu bar, use the ⚙️ **Settings** icon to view the notebook settings.

10. Set the **Name** of the notebook to **Train and compare models notebook**, and then close the settings pane.

11. On the notebook menu, select **Stop session** to end the Spark session.
